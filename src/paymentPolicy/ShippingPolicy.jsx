    ...
    <div>
      <div className="p-6">
        ...
        <p>
          ...
          Company / post office norms. RAMASAMY VIMALKUMAR is not liable for any
          delay in delivery by the courier company / postal authorities and only
          guarantees to hand over the consignment to the courier company or
          postal authorities within 1-2 days rom the date of the order and
          ...
          services you may contact our helpdesk on 9360232422 or
          vimal21082003@gmail.com
        </p>
      </div>
    </div>
  );
